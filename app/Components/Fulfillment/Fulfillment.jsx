        ...
        <div className="flex justify-between ml-[80px] ">
            ...
            <div className="w-[532px] h-[409px] mt-[342px] ml-[200px]  ">
                ...
                <div className="mt-[34px] flex gap-[20px] ">
                    ...
                    <button className="text-[18px]  w-[217px] h-[61px] bg-[#0084ff] rounded-[35px] text-[#ffffff] font-semibold tracking-[1px] font-sora" 
                     style={{ boxShadow: '0px 10px 20px #0084ff50' }}>
                    Fulfillment Price
                    </button>
                    <button className="border border-[#0084ff] rounded-[35px] w-[198px] h-[61px] shadow-[#0084ff50]"
                    >
                    FBA Prep Price
                    </button>
