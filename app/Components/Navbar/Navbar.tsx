    ...
    >
      <div className="max-w-[375px] lg:max-w-[1024px] xl:max-w-[1280px] 2xl:max-w-[1440px] mx-auto">
        <div className="w-[325px] lg:w-[904px] xl:w-[1150px] 2xl:w-[1350px] mx-auto">
          <div className="flex justify-between items-center my-4 lg:my-6 xl:my-[34px] 2xl:my-[30px]">
            {/* Left Side: Logo */}
            <Link href="#">
              <Image
                src="/Images/Logo.png"
            ...
            <div className="hidden lg:flex items-center gap-6 lg:gap-[58px] xl:gap-[118px] 2xl:gap-[119px]">
            ...
            <div className="lg:hidden">
              <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
                {isMobileMenuOpen ? <IoMdClose size={28} color="#020C12" /> : <HiOutlineMenuAlt3 size={28} color="#020C12" />}
              </button>
            </div>
          </div>
