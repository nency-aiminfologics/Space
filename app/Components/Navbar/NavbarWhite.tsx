      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="mx-[80px] flex justify-between my-[30px]">
          ...
          <div className="w-[548px] mt-[21.5px]">
            <ul
              className={`text-[18px] ${
                isScrolled ? "text-[#020C12]" : "text-white"
          ...
          {/* CTA Button */}
          <div
            className={`w-[194px] h-[61px] rounded-[35px] mt-[3px] transition-all duration-300 ${
              isScrolled ? "bg-[#0084FF]" : "bg-white"
            }`}
            style={{
          ...
          >
            <button
              className={`text-[18px] w-[194px] h-[61px] transition-colors duration-300 font-semibold ${
                isScrolled ? "text-white" : "text-[#020C12]"
              }`}
            >
              Get Started
            </button>
