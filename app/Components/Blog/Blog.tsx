...
export default function Blog() {
    return (
        <>
            <div className='2xl:w-[1440px] mx-auto 2xl:h-[898px] xl:w-[1280px] xl:h-[760.11px] w-[375px] h-[640px]'>
                <div className='2xl:h-[998px] 2xl:w-[1273px] xl:w-[1131px] xl:h-[887.71px] w-[330px] h-[640px]  mx-auto '>
                    <div className='2xl:mt-[120px] xl:mt-[114.78px] mt-[40px]'>

                        <h1 className='2xl:text-[20px] xl:text-[18px] text-[14px] text-[#0084FF] font-semibold 2xl:leading-[28px] xl:leading-[28px]
                    leading-[24.89px] font-sora tracking-[0px] '>Blog & Insights</h1>
                        {/* mobile */}
                        <h1 className='2xl:hidden xl:hidden block w-[215px] text-[20px] leading-[100%] tracking-[1%] font-extrabold mt-[5px]'>FBA TIPS, TRICKS & BEST PRACTICES</h1>
                        <div className='2xl:hidden xl:hidden block mt-[30px] relative w-[327px] h-[218px] mx-auto'>
                            {/* Image */}
                            <Image
                        ...
                        <div className='2xl:hidden xl:hidden block mt-[15px] relative w-[327px] h-[218px] mx-auto'>
                            {/* Image */}
                            <Image
                        ...
                        <Link href="/blog">
                                <div className="flex 2xl:hidden xl:hidden gap-[10px] mt-[20px] ">
                    ...
                    {/* desktop screen */}
                        ...
                        <div className='2xl:flex xl:flex hidden justify-between 2xl:mt-[14px] xl:mt-[13.22px]'>
                            <h1 className='2xl:w-[474px] 2xl:text-[48px] xl:w-[421.33px] xl:text-[42px] leading-[48px] tracking-[1%] 
                    font-extrabold   text-[#020C12] '>FBA TIPS, TRICKS & BEST PRACTICES</h1>
                            <Link href="/blog">
                    ...
                    <div className=' 2xl:h-[490px] xl:h-[436px] 2xl:mt-[68px] xl:mt-[54.11px]  2xl:flex xl:flex hidden justify-between relative '>
                        <div>
