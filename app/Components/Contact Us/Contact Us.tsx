                           ...
                           placeholder-white text-[14px] pl-[16px] bg-[#ffffff2f] backdrop-blur-[4px]  outline-none '/>
                            ...
                            placeholder-white text-[14px] pl-[16px] bg-[#ffffff2f] backdrop-blur-[4px] outline-none'/>
                                ...
                                <textarea
                                    ...
                                    className="w-[615px] h-[96px] border border-[#ffffff] rounded-[10px] mt-[17px] text-[#ffffff]
             placeholder-white text-[14px] pl-[16px] pt-[12px] bg-[#ffffff2f] backdrop-blur-[4px] outline-none resize-none"
                                />
