...
export default function OurFeatures() {
     ...
     <>
      ...
      <div className="2xl:w-[1440px] xl:w-[1280px] 2xl:py-[120px] xl:py-[106.67px] mx-auto">
        <div className="2xl:w-[1244px] xl:w-[1150px] mx-auto  ">
          ...
          <div className="flex 2xl:gap-[35px] xl:gap-[31.11px] 2xl:mt-[90px] xl:mt-[80.33px]  
          2xl:w-[1060px] xl:w-[1108px]   mx-auto">
  ...
  `}
                ...
                >
                  {/* Number Circle */}
                  <div className="2xl:w-[64px] 2xl:h-[64px] xl:w-[64px] xl:h-[64px] 
                  2xl:mt-[32px] xl:mt-[28px] 2xl:mx-[39px] xl:mx-[37px]">
                    ...
                    <div className="flex flex-col justify-between ">
                      <div>
                        ...
                        <Image
                          ...
                          width={407}
                          height={160}
                          className="2xl:rounded-[10px] xl:rounded-[10px] 2xl:mt-[29px] xl:mt-[35px] 2xl:w-[407px] 2xl:h-[160px] xl:w-[362px] xl:h-[127px]"
                        />
                      </div>
                    </div>
                  </div>
