...
export default function OurBenefits() {
  return (
    <>
      <div
        className="bg-cover bg-center bg-no-repeat w-full h-[890px] mx-auto  overflow-y-scroll scrollbar-hide"
        style={{ backgroundImage: `url("/Images/Benefits-bg.png")` }}
      >
        <div className=" ml-[320px]  flex justify-between">
          <div className="relative">
            <h1 className="text-[#020C12] sticky top-0 w-full text-[48px] font-bold uppercase leading-[100%] tracking-[1px] pt-[100px]">
              OUR BENEFITS
            </h1>
            </div>
            <div className="pt-[100px] space-y-[30px] h-[890px] sticky  ">
