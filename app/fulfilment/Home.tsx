    ...
    return (
        ...
        <div className="w-full">
            <div className=" w-[325px] 2xl:w-[1350px] xl:w-[1150px] lg:w-[904px] mx-auto">
                <div className=" z-10 absolute  2xl:mt-[30%] xl:mt-[326px] lg:mt-[300px] mt-[140px] ">
        ...
        leading-[100%] tracking-[0px]  ">Fulfillment</h1>
                    ...
                    leading-[28px] 2xl:mt-[8px] xl:mt-[10px] mt-[6px] lg:mt-[8px]">Smooth Fulfillment, Streamlined Logistics</p>
                    <button onClick={() => {
