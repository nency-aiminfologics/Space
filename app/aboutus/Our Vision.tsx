    ...
    return(
      ...
      >
        <div className="2xl:w-[1440px] xl:w-[1280px] w-[325px] mx-auto 2xl:mx-[280px] xl:mx-[65px]">
            ...
            <div className="flex 2xl:flex-row xl:flex-row flex-col justify-between  xl:w-[1150px] 2xl:w-[1350px] w-[325px] ">
                <h1 className="uppercase text-[#020C12] 2xl:text-[48px] xl:text-[42px] text-[20px]
                 font-bold 2xl:leading-[100%] xl:leading-[100%] leading-[28px] 2xl:tracking-[1px] xl:tracking-[0.89px] ">Our Vision</h1>
                <div>
                    <p className="text-[#020C12] 2xl:text-[18px] xl:text-[18px] text-[14px] font-normal 2xl:w-[609px] xl:w-[605px] w-[325px]
                    2xl:leading-[28px] xl:leading-[24.89px] leading-[24.89px] mt-[20px] 2xl:mt-0 xl:mt-0 tracking-[0px] ">
                        At Space City Prep, we believe that e-commerce businesses should be able to focus on what they do best
                         ...
                         2xl:leading-[28px] xl:leading-[24.89px] leading-[24.89px] tracking-[0px]
                          2xl:mt-[30px] xl:mt-[40px] mt-[10px]">
            ...
            width={1350}
            height={370}
            className=" 2xl:mt-[64px] xl:mt-[64px] mt-[32px] 2xl:w-[1350px] 2xl:h-[370px] xl:w-[1150px] xl:h-[328px] w-[327px] h-[128px]"/>
