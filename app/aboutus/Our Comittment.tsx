            ...
            <div className="2xl:w-[1440px] xl:w-[1280px] mx-auto">
                <div className="2xl:w-[829px] xl:w-[786px] mx-auto   ">
                   ...
                   <div className="2xl:mt-[32px] xl:mt-[29px]">
                    ...
                    text-center text-[#020C12] font-normal 2xl:mt-[25px] xl:mt-[20px] mx-auto">At Space City Prep, we focus on speed, reliability, and smart solutions. We understand the pressure of meeting Amazon and Walmart's strict standards,
