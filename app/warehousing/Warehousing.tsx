                    ...
                    <div className="2xl:w-[1244px] xl:w-[1150px] 2xl:mx-auto xl:mx-[65px] ">
                        <div className="flex justify-between  ">
                            <div className="">
                                ...
                                xl:tracking-[0.89px]">Warehousing</h1>
                                ...
                                2xl:w-[549px] xl:w-[488px]  font-normal 
                                 2xl:leading-[28px] xl:leading-[24.89px] tracking-[0px]
                                  2xl:mt-[28px] xl:mt-[25px] ">EWelcome to Space City Prep, where your supply
                            ...
                            <Image src="/Images/warehousebox.png" alt="prepbox"
                                width={524}
                                height={318} className="2xl:w-[524px] 2xl:h-[318px] xl:w-[466px] 
                                xl:h-[282px]" />
                        </div>
