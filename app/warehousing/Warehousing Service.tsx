...
export default function WarehousingService() {
  ...
  return (
    <>
      <div className="w-full 2xl:py-[127px] xl:py-[113px] lg:py-[72px]  mx-auto 2xl:block xl:block lg:block hidden">
        <div className="2xl:w-[1244px] xl:w-[1150px] lg:w-[904px] mx-auto">
          ...
          font-semibold 2xl:leading-[28px] xl:leading-[24.89px] lg:leading-[24.89px]  text-center">
            ...
            <h1 className="2xl:text-[48px] xl:text-[42px] lg:text-[32px] text-[#020C12] font-extrabold 
          text-center uppercase leading-[100%] tracking-[1px] 2xl:mt-[14px] xl:mt-[12.29px] lg:mt-[10px]">
              Storage That Grows With You
            </h1>

            <p className="text-[#020C12] 2xl:text-[18px] xl:text-[18px] lg:text-[16px] 
          font-normal 2xl:leading-[28px] xl:leading-[24.89px] lg:leading-[23px] 2xl:w-[704px] xl:w-[714px] lg:w-[714px]
          text-center 2xl:mx-[83px]  xl:px-[60px] 2xl:mt-[20px] xl:mt-[20px] lg:mt-[18px]">
         ...
         flex 2xl:gap-[25px] xl:gap-[25px] lg:gap-[20px] flex-row mx-auto">
            {services.map((service, index) => (
              <div
                key={index}
                className={`2xl:w-[291px]  xl:w-[258px]  lg:w-[215px] 
                 bg-gradient-to-b from-[#D6D6D6] to-[#FFFFFF] 2xl:rounded-[20px] xl:rounded-[20px] lg:rounded-[20px] ${(index === 0 || index === 2) ? "2xl:mt-[45px] xl:mt-[40px] lg:mt-[26px]" : ""
                  }`}
              >
                <div className="2xl:mx-[20px] xl:mx-[18px] lg:mx-[12px] 2xl:py-[20px] xl:py-[18px] lg:py-[12px]">
                  <Image
                    ...
                    width={251}
                    height={184}
                    className="2xl:rounded-[20px] xl:rounded-[18px] lg:rounded-[18px]  
                  2xl:w-[251px] 2xl:h-[184px] xl:w-[223px] xl:h-[163px] lg:w-[191px] lg:h-[140px]"
                  />
                  <div className="flex 2xl:flex-row xl:flex-row lg:flex-col 2xl:mt-[20px] xl:mt-[15px] lg:mt-[15px] justify-between">
                    <h1 className="text-[#000000] 2xl:text-[20px] xl:tex-[18px] lg:text-[16px] font-semibold 2xl:leading-[28px] xl:leading-[24.89px] lg:leading-[24.89px] ">
                      {service.title}
                    </h1>
                    <h1 className="text-[#020C1299] 2xl:text-[16px] xl:text-[16px] lg:text-[16px] font-normal
                 2xl:leading-[24px] xl:leading-[24px] lg:leading-[24px]">{service.size}</h1>
                  </div>
                  <h1 className="text-[#606060] 2xl:text-[16px] xl:text-[14px] lg:text-[14px]
                  font-normal 2xl:mt-[17px] xl:mt-[15px] lg:mt-[20px]">Storage</h1>

                  <div className="2xl:mt-[8px] xl:mt-[8px] lg:mt-[5px] flex gap-[5px]">

                    <h1 className="text-[#000000] 2xl:text-[28px] xl:text-[24px] lg:text-[24px] font-bold 2xl:leading-[34px] xl:leading-[35px] ">
                      {service.price}
                    </h1>

                    <h1 className="text-[#606060] 2xl:text-[16px] xl:text-[16px] lg:text-[16px]
                 2xl:mt-[10px] xl:mt-[6px] lg:mt-[6px]">/per week</h1>
                  </div>

                  <button onClick={() => {
                    document.getElementById("contact-us")?.scrollIntoView({ behavior: "smooth" });
                  }}
                    className="2xl:w-[251px] 2xl:h-[50px] xl:w-[223px] xl:h-[44px] lg:w-[191px] lg:h-[44px]
                    border border-[#020C12] xl:rounded-[30px] 2xl:rounded-[35px] lg:rounded-[30px]
                     text-[#020C12] 2xl:text-[18px] xl:text-[16px] lg:text-[16px] font-semibold 
                  leading-[100%] tracking-[1px] 2xl:mt-[17px] lg:mt-[20px] xl:mt-[20px]"
          ...
          <div className="2xl:w-[676px] xl:w-[580px] lg:w-[569px]  mx-auto 2xl:mt-[100px] xl:mt-[100px] lg:mt-[50px]">
            <h1 className="text-[#020C12] 2xl:text-[32px] xl:text-[28px] lg:text-[26px]
             font-bold leading-[36px] tracking-[1px] text-center">Discounted shipping rates</h1>

            <p className="2xl:w-[676px] xl:w-[580px] lg:w-[569px]   text-[#020C12] font-normal
             2xl:text-[18px] xl:text-[16px] lg:text-[16px] text-center 2xl:mt-[25px] xl:mt-[20px] lg:mt-[16px]">
              We help reduce your shipping costs and labor. By serving a wide range of
            ...
            <Link href="/pricefulfilment">
              <div className="flex 2xl:gap-[15px] xl:gap-[13px] lg:gap-[13.97px] 2xl:mt-[45px] xl:mt-[45px] lg:mt-[36px] justify-center">

                <Image src="/Images/lefticon.png" alt="icon" width={68} height={45} className="2xl:w-[68px] 2xl:h-[45px] xl:w-[60px] xl:h-[40px] lg:w-[60.31px] lg:h-[40px]" />

                <span className="2xl:text-[20px] xl:text-[18px] lg:text-[18px] text-[#0084FF] leading-[100%] tracking-[1%] font-sora font-bold mt-3">
                  See All Prices
                </span>
              </div>
            </Link>
      ...
      <div className="w-full  2xl:hidden xl:hidden lg:hidden block">
        <div className=" ">
